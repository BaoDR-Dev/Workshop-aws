...
![Select the CPUUtilization metric for recruitpro-db](</Workshop-aws/images/5-Workshop/5.10-Monitoring-va-Alert/5.10.5-Tao-CloudWatch-Alarm-cho-RDS-CPU/chon-metric-rds-cpu.jpg>)
...
![Configure the RDS CPU threshold](</Workshop-aws/images/5-Workshop/5.10-Monitoring-va-Alert/5.10.5-Tao-CloudWatch-Alarm-cho-RDS-CPU/cau-hinh-nguong-rds-cpu.jpg>)
...
![Select the SNS topic for RDS CPU notifications](</Workshop-aws/images/5-Workshop/5.10-Monitoring-va-Alert/5.10.5-Tao-CloudWatch-Alarm-cho-RDS-CPU/chon-sns-topic.jpg>)
...
![Name the high-CPU RDS CloudWatch alarm](</Workshop-aws/images/5-Workshop/5.10-Monitoring-va-Alert/5.10.5-Tao-CloudWatch-Alarm-cho-RDS-CPU/dat-ten-alarm.jpg>)
...
![Review and create the RDS CPU CloudWatch alarm](</Workshop-aws/images/5-Workshop/5.10-Monitoring-va-Alert/5.10.5-Tao-CloudWatch-Alarm-cho-RDS-CPU/xem-lai-va-tao-alarm.jpg>)
