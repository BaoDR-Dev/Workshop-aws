...
![Select the CPUUtilization metric for the RecruitPro-BE instance](</Workshop-aws/images/5-Workshop/5.10-Monitoring-va-Alert/5.10.2-Tao-CloudWatch-Alarm-cho-EC2-CPU/chon-metric-ec2-cpu.jpg>)
...
![Configure the CPU alarm condition](</Workshop-aws/images/5-Workshop/5.10-Monitoring-va-Alert/5.10.2-Tao-CloudWatch-Alarm-cho-EC2-CPU/cau-hinh-nguong-cpu.jpg>)
...
![Select the SNS topic for CPU alarm notifications](</Workshop-aws/images/5-Workshop/5.10-Monitoring-va-Alert/5.10.2-Tao-CloudWatch-Alarm-cho-EC2-CPU/chon-sns-topic.jpg>)
...
![Name the EC2 CPU CloudWatch alarm](</Workshop-aws/images/5-Workshop/5.10-Monitoring-va-Alert/5.10.2-Tao-CloudWatch-Alarm-cho-EC2-CPU/dat-ten-alarm.jpg>)
...
![Review and create the CloudWatch alarm](</Workshop-aws/images/5-Workshop/5.10-Monitoring-va-Alert/5.10.2-Tao-CloudWatch-Alarm-cho-EC2-CPU/xem-lai-va-tao-alarm.jpg>)
